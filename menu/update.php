			...
			<?php foreach ($datas as $key => $menu): ?>
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<input type="text" value="<?php echo $menu['menu'] ?>" name="menu" placeholder="Username" class="col-xs-10 col-sm-5" autocomplete="off">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="radio">
						<label>
							<input name="by_url" type="radio" class="ace radio-url" value="1" <?php if($menu['by_url'] == 1)echo "checked"; ?>>
							<span class="lbl"> Yes</span>
						</label>
						<label>
							<input name="by_url" type="radio" class="ace radio-url" value="2" <?php if($menu['by_url'] == 2)echo "checked"; ?>>
				...
				<div class="form-group" id="address">
					...
					<div class="col-sm-10">
						<input type="text" value="<?php echo $menu['url'] ?>" name="url" placeholder="URL Address" class="col-xs-10 col-sm-5" autocomplete="off">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right"> Icon </label>
					<div class="col-sm-10">
						<input type="text" value="<?php echo $menu['icon'] ?>" name="icon" placeholder="Icon" class="col-xs-10 col-sm-5" autocomplete="off">
				...
				<div class="col-sm-10">
					<div class="checkbox">
						<label>
							...
							<input name="admin" class="ace ace-checkbox-2" type="checkbox" value="1" <?php if($menu['admin'] == 1)echo "checked"; ?>>
							<span class="lbl"> Admin</span>
						</label>
						<label>
							<input type="hidden" name="dosen" value="0">
							<input name="dosen" class="ace ace-checkbox-2" type="checkbox" value="1" <?php if($menu['dosen'] == 1)echo "checked"; ?>>
							<span class="lbl"> Dosen</span>
						</label>
						<label>
							<input type="hidden" name="mahasiswa" value="0">
							<input name="mahasiswa" class="ace ace-checkbox-2" type="checkbox" value="1" <?php if($menu['mahasiswa'] == 1)echo "checked"; ?>>
