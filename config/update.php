...
<?php if ($result): ?>
	...
	document.location='index.php?p=list<?php echo ucfirst($table) ?>&message=updated';
	</script>
<?php else: ?>
	<script language="javascript">
	document.location='index.php?p=update<?php echo ucfirst($table) ?>&id=<?php echo $id ?>&message=error';
	</script>
<?php endif ?>