...
<div>
	<a href="index.php?p=addSoalDosen" class="btn btn-primary <?php if ($_GET['p'] == listMahasiswa) echo "hide"; ?>">
    	...
    	<table id="sample-table-2" class="table table-responsive table-striped table-bordered table-hover">
            ...
            <?php foreach ($contents as $key => $content): ?>
                ...
                <?php foreach ($fillContent as $key => $value): ?>
                    ...
                    ?>
                    <td>
                        <a class="sorting" href="index.php?p=detailSoalDosen&id=<?php echo $id?>"><?php echo $fills ?></a>
                    </td>
                <?php endforeach ?>
                	<td>
    					<div class="hidden-sm hidden-xs action-buttons">
    						<a class="blue" href="index.php?p=detailSoalDosen&id=<?php echo $id ?>" title="Detail">
    							<i class="ace-icon fa fa-search-plus bigger-130"></i>
    						</a>

    						<a class="green" href="index.php?p=updateSoalDosen&id=<?php echo $id ?>" title="Edit">
    							<i class="ace-icon fa fa-edit bigger-130"></i>
    						</a>

    						<a class="red" href="index.php?p=deleteSoalDosen&id=<?php echo $id ?>" title="Hapus">
                        ...
                        <div class="hidden-md hidden-lg">
                            <div class="inline position-relative">
                                ...
                                <ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
                                    <li>
                                        <a href="index.php?p=detailSoalDosen&id=<?php echo $id ?>" class="tooltip-info" data-rel="tooltip" title="Detail">
                                            <span class="blue">
                                    ...
                                    <li>
                                        <a href="index.php?p=updateSoalDosen&id=<?php echo $id ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
                                            <span class="green">
                                    ...
                                    <li>
                                        <a href="index.php?p=deleteSoalDosen&id=<?php echo $id ?>" class="tooltip-error" data-rel="tooltip" title="Hapus">
                                            <span class="red">
