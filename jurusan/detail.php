		...
		<form action="index.php?p=simpan" method="POST" class="form-horizontal">
			<?php foreach ($datas as $key => $jurusan): ?>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" value="<?php echo $jurusan['kd_jurusan'] ?>" name="username" class="col-xs-10 col-sm-5" readonly>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-right"> Nama Jurusan </label>
					<div class="col-sm-10">
						<input type="text" value="<?php echo $jurusan['nm_jurusan'] ?>" name="password" class="col-xs-10 col-sm-5" readonly>
					</div>
				</div>
