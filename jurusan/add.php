		...
		<form action="index.php?p=simpan" method="POST" class="form-horizontal">
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<input type="text" name="kd_jurusan" placeholder="Kode Jurusan" class="col-xs-10 col-sm-5" required autocomplete="off">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-right"> Nama Jurusan </label>
				<div class="col-sm-10">
					<input type="text" name="nm_jurusan" placeholder="Nama Jurusan" class="col-xs-10 col-sm-5" required autocomplete="off">
				</div>
			</div>
