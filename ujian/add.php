...
<div class="row">
	<div class="col-xs-12">
		<form action="index.php?p=createUjian" method="POST" class="form-horizontal" enctype="multipart/form-data">
			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-right"> Taggal Ujian </label>
				<div class="col-sm-4">
					<input type="date" name="tanggal_ujian" class="form-control" required autocomplete="off">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-right"> Jam Buka </label>
				<div class="col-sm-4">
					<input type="time" name="jam_buka" class="form-control" required autocomplete="off">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-right"> Jam Tutup </label>
				<div class="col-sm-4">
					<input type="time" name="jam_tutup" class="form-control" required autocomplete="off">
				</div>
			</div>
			<div class="form-group">
